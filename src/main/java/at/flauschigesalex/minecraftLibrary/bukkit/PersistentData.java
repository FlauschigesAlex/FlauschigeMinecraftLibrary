...
public final class PersistentData {
    ...
    public PersistentData(final @NotNull ItemStack itemStack) {
        this(itemStack.getItemMeta(), null);
    }
    public PersistentData(final @NotNull ItemStack itemStack, final @Nullable Plugin plugin) {
    ...
    public PersistentData(final @NotNull PersistentDataHolder container, final @Nullable Plugin plugin) {
