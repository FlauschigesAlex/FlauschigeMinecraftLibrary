...
abstract class ItemBuilder private constructor() {
    companion object {
        operator fun invoke(material: Material): DefaultBuilder<*> {
            return DefaultBuilder(material)
        }
        operator fun invoke(): DefaultBuilder<*> {
            return DefaultBuilder(defaultMaterial)
        }
        ...
        fun colored(material: Material): ColoredBuilder {
            ...
            return ColoredBuilder(material)
        }
        ...
        var defaultHideTooltip: Boolean? = true
        var defaultFireResistant: Boolean? = null
    }
}

open class DefaultBuilder<I: DefaultBuilder<I>> internal constructor(private val material: Material) {
    ...
    fun setEnchantmentGlint(glint: Boolean): I {
    ...
    fun clearEnchantments(): I {
        this.enchants.clear()
        return this as I
    }
    fun addEnchantment(enchantment: Enchantment, level: Int): I {
        this.enchants[enchantment] = level
        return this as I
    }
    fun removeEnchantments(enchantment: Set<Enchantment>): I {
        enchantment.forEach { this.enchants.remove(it) }
        return this as I
    }
    fun removeEnchantments(vararg enchantment: Enchantment): I {
        return this.removeEnchantments(enchantment.toSet())
    }
    fun removeEnchantment(enchantment: Enchantment, level: Int): I {
        this.enchants.remove(enchantment, level)
        return this as I
    }
    fun setEnchantments(enchantments: Map<Enchantment, Int>): I {
...
class ColoredBuilder internal constructor(material: Material) : DefaultBuilder<ColoredBuilder>(material) {
...
class SkullBuilder internal constructor(material: Material) : DefaultBuilder<SkullBuilder>(material) {
